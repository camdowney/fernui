...
export default function Checkbox({ innerRef, id, name, label, className, required, onChange, message }) {
    ...
    return (<div ref={outerRef} className={cn('fui-field', showInfo && 'fui-field-invalid', className)}>
      <label style={wrapperStyle}>
        <input ref={innerRef} id={id} type='checkbox' name={name || label} data-field-valid={!invalid} onChange={e => { update(e), onChange && onChange(e); }} onBlur={update} disabled={formState.disabled} style={inputStyle}/>
