...
export default function Form({ className, children, states = [], onStateChange, onSubmit, maxAttempts = 99, maxSubmissions = 1, }) {
    ...
    return (React.createElement("form", { ref: formRef, method: 'post', onSubmit: handleSubmit, className: cn('fui-form', className), noValidate: true },
        React.createElement(Honeypot, null),
        children));
}
